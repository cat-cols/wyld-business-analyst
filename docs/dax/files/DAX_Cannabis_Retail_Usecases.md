...
### When Asked: "Do you know Power BI?"

**Response:**
> "I haven't worked extensively in Power BI yet, but I've studied DAX patterns 
> and understand the core concepts translate directly from my Tableau and SQL 
> experience:
> 
> - CALCULATE in DAX = LOD expressions in Tableau = filtered aggregations in SQL
> - DAX iterators (SUMX) = row-level calculations in Tableau
> - Time intelligence in DAX = date calculations in SQL with window functions
> 
> For instance, if I needed to calculate year-over-year growth in Power BI, I'd 
> use CALCULATE with SAMEPERIODLASTYEAR. In Tableau, I use LOOKUP with table 
> calculations. The logic is identical, just different syntax.
> 
> I've specifically prepared for cannabis retail analytics - margins by category, 
> state performance, product lifecycle metrics. I'm confident I can deliver the 
> insights Wyld needs in Power BI within 2-3 weeks of onboarding."

---

### When Asked: "How would you analyze product performance?"

**Response:**
> "I'd build several DAX measures to create a comprehensive view:
> 
> 1. Revenue and unit metrics by product and category
> 2. Gross margin calculations showing profitability
> 3. Time-based comparisons (YoY, MoM) to identify trends
> 4. Market share or mix percentages to understand portfolio composition
> 5. Ranking/segmentation to prioritize focus areas
> 
> For Wyld specifically, I'd want to understand:
> - How are gummies performing vs. beverages?
> - What's the margin difference between THC and CBD products?
> - Which new launches are meeting their 90-day forecasts?
> - Are there cannibalization effects between product lines?
> 
> I'd use CALCULATE for filtered aggregations, iterator functions like SUMX for 
> row-level operations, and time intelligence to track growth patterns."

---

## 📚 STUDY CHECKLIST

**Before Wyld Interview:**

- [ ] Memorize core DAX functions (SUM, CALCULATE, DIVIDE, SUMX)
- [ ] Understand filter context vs. row context
- [ ] Practice translating Tableau calcs to DAX in your head
- [ ] Review cannabis-specific scenarios above
- [ ] Prepare 2-3 "I'd use DAX like this..." examples
- [ ] Practice saying "I understand DAX logic even without Power BI experience"

**Key Confidence Builders:**
- You understand the LOGIC (that's 90% of it)
- DAX syntax is learnable in 2 weeks
- Your SQL and Tableau skills transfer directly
- You've studied cannabis-specific use cases
- You can articulate HOW you'd solve problems even if you haven't used the exact tool
